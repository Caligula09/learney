const translations = {
    de: {
        ...
        no_date_alert: "Bitte gib ein erlaubtes Datum ein.",
        no_oldDate_alert: "Bitte gib ein Datum aus der Zukunft ein.",
        too_short_alert: 'Die Lerneinheit darf nicht länger als die gesamt Zeit sein.',

        sub_name_error: 'Bitte gib einen unbenutzten und erlaubten Namen ein',
    ...
    en: {
        ...
        no_date_alert: "Please enter a valid date.",
        ...
        sub_name_error: 'Please enter a valid and unused name',
